    ...
    if provider_changed or explicit_provider:
        ...
        if keep_current_ollama_endpoint:
            ...
            try:
                ...
                # Named custom providers can resolve to the generic "custom"
                # fallback. Keep the live session credentials in that case;
                # otherwise adopt refreshed credentials and routing metadata.
                ...
                auth_type = (
                    getattr(provider_def, "auth_type", "")
